...
\def \Keywords {Machine Learning, Credit Risk, Loans, Probability of Default, Python, Bayesian Optimization, Web Application}
\def \Klic {Strojov\'{e} u\v{c}en\'{i}, Machine Learning, Kreditn\'{i} riziko, \'{U}v\v{e}ry, Pravd\v{e}podobnost defaultu, Python, Bayesovsk\'{a} optimalizace, Webov\'{a} aplikace}				
