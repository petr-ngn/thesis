...
\def \Bookname {Implementation of Machine Learning Algorithms within Credit Risk Modelling}
\def \BooknameCZ {Implementace Machine Learning algoritm\'{u} v r\'{a}mci modelov\'{a}n\'{i} kreditn\'{i}ho rizika} 
...
\def \Keywords {machine learning, credit risk, loans, probability of default, Python}
\def \Klic {strojov\'{e} u\v{c}en\'{i}, machine learning, kreditn\'{i} riziko, \'{u}v\v{e}ry, pravd\v{e}podobnost defaultu, Python} 					
...
\begin{filecontents*}{Thesis.xmpdata}
		\Author{Petr Nguyen} 
		\Title{Implementation of Machine Learning Algorithms within Credit Risk Modelling}
