...
\def \Bookname {Application of Machine Learning Models within Credit Risk Modelling}
\def \BooknameCZ {Aplikace model\'{u} strojov\'{e}ho u\v{c}en\'{i} v r\'{a}mci modelov\'{a}n\'{i} kreditn\'{i}ho rizika} 
...
\def \Keywords {Machine Learning, Credit Risk, Loans, Probability of Default, Python, Web Application, Bayesian Optimization}
\def \Klic {Strojov\'{e} u\v{c}en\'{i}, Machine Learning, Kreditn\'{i} riziko, \'{U}v\v{e}ry, Pravd\v{e}podobnost defaultu, Python, Webov\'{a} aplikace, Bayesovsk\'{a} optimalizace}				
...
\def \StudyProgram {Banking and Insurance}
\def \MinorTrack{Data Engineering}
...
\begin{filecontents*}{Thesis.xmpdata}
		\Author{Petr Nguyen} 
		\Title{Application of Machine Learning Models within Credit Risk Modelling}
	  \Keywords{Machine Learning, Credit Risk, Loans, Probability of Default, Python, Bayesian Optimization}
