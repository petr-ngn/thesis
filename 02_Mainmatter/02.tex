...
International Accounting Standard Board (IASB) in cooperation with the Financial Accopunting Standard Board (FASB) introduced International Financial Reporting Standard (IFRS) 9 in order to replace IAS 39 \citep{porretta2020credit}


In

International Financial Reporting Standard number 9 (IFRS 9)
