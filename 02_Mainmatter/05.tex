...
\textbf{TBD} - Oversampling generates a lot of synthetic default instances for managers.
...
As such, $n_B$ and $n_A$ refer to the number of default cases within given category before and after oversampling, respectively, $N_B$ and $N_A$ represents the total number of default cases before and after oversampling, respectively, hence $n_{B} / N_{B}$ and $n_{A} / N_{A}$ is
...
\subsubsection{Hyperparameters' spaces}
...
\textbf{ADD BRIEF THEORY ABOUT THE FEATURE IMPORTANCE}
