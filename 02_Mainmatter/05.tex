...
If we aggregate the model selection results, we can observe that the best KNN model had the 11th highest rank, while Neural Network (MLP) exhibited unsatisfactory performance with the 22nd highest rank as can be seen in \autoref{tab:maxranks}.
...
\begin{table}[H]
    ...
    \centering
        \caption[Aggregated Ranks of Models]{Aggregated Ranks of Models}\label{tab:maxranks}
        \begin{tabular}{r r}
    \toprule
