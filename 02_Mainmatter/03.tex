...
The former phase usually uses decision tree to generate initial split points. \citep{navas2020optimal} such as:
\begin{itemize}\setlength\itemsep{0em} 
    ...
    \item Each bin should have at least one instance of each target class: Application of such constraint allows to compute divergence measures.
\end{itemize}
