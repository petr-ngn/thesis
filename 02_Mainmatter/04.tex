...
\begin{equation}\label{eq}
    NormRankScore_{M} = 1 - \frac{RankScore_{M} - RankScore_{MAX}}{RankScore_{MAX} - RankScore_{MIN}}
\end{equation}
...
Nonetheless, given the relatively small sample size, KNN performs better than Neural Network and non-linear SVM on small datasets.
\begin{figure}[H]
\centering
