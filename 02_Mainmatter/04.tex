...
As can be seen in \autoref{tab:dataset}, the dataset contains 13 columns, 11 features and 1 target variable \texttt{BAD} indicating whether the loan was in default (\texttt{1}) or not (\texttt{0}). 
...
The custom function \lstinline{model_selection()} iterively prints the process of the model tuning and end evaluation on each subset of features, in order to keep the track of such process as it is depicted in \autoref{fig:modselprint}.
...
\begin{figure}[H]
    \centering
    \caption{Model Selection Print Statement}\vspace{0.5em}
    \label{fig:modselprint}\
    \includegraphics[width=140mm]{Figures/model_selection_print.jpg}
    \centering{\begin{source}Author's results in Python.\end{source}}\vspace{-1em}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{1.3cm}|p{1.2cm}|p{1.4cm}|p{1.6cm}|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
        \toprule
        \textbf{Tuned model} & \textbf{FS model} & \# \newline Features & Execution time & Threshold & F1 & Precision & Recall & Accuracy & AUC & SD & KS & MCC & JC & BSL & ZOL & rank \\
        \midrule
        \hline
        GB & KNN & 11 & 814 & 0.5072 & 0.7978 & 0.7912 & 0.8045 & 0.9184 & 0.9587 & 0.9175 & 0.7989 & 0.7467 & 0.6636 & 0.0687 & 0.08156 & 1 \\
        
        GB & SVM & 11 & 951 & 0.5053 & 0.7896 & 0.8155 & 0.7654 & 0.9184 & 0.9555 & 0.9109 & 0.7961 & 0.7397 & 0.6524 & 0.0718 & 0.0816 & 2 \\
        GB & MLP & 10 & 776 & 0.4955 & 0.7809 & 0.7853 & 0.7765 & 0.9128 & 0.9515 & 0.9030 & 0.7751 & 0.7265 & 0.6406 & 0.0666 & 0.0872 & 3 \\
        GB & GB & 11 & 723 & 0.4132 & 0.7799 & 0.7778 & 0.7821 & 0.9117 & 0.9543 & 0.9086 & 0.7989 & 0.7247 & 0.6393 & 0.0703 & 0.0883 & 4 \\
\ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots & \ldots \\
GNB & MLP & 10 & 23 & 0.2194 & 0.6013 & 0.5000 & 0.7542 & 0.8000 & 0.8493 & 0.6986 & 0.5768 & 0.4930 & 0.4299 & 0.1319 & 0.2000 & 60.\\
GNB & GNB & 6 & 23 & 0.4787 & 0.5950 & 0.5039 & 0.7263 & 0.8022 & 0.8356 & 0.6711 & 0.5559 & 0.4835 & 0.4235 & 0.1470 & 0.1978 & 61 \\
        LR & GNB & 6 & 93 & 0.4561 & 0.5949 & 0.5121 & 0.7095 & 0.8067 & 0.8379 & 0.6758 & 0.5531 & 0.4831 & 0.4235 & 0.1319 & 0.1933 & 62 \\
        GNB & SVM & 11 & 22 & 0.1991 & 0.5885 & 0.4872 & 0.7430 & 0.7922 & 0.8425 & 0.6850 & 0.5712 & 0.4756 & 0.4169 & 0.1345 & 0.2078 & 63 \\
        GNB & RF & 11 & 23 & 0.3413	& 0.5863 & 0.4943 & 0.72067 & 0.7967 & 0.8288 & 0.6577 & 0.5545	& 0.4720 & 0.4148 & 0.1486 & 0.2034 & 64 \\
        \hline
        \bottomrule 
    \end{tabular}}
    \vspace{1em}
...
\begin{figure}[H]
    ...
    \caption{Model Selection Print Statement}\vspace{0.5em}
    \label{fig:modselprint}\
    \includegraphics[width=150mm]{Figures/model_selection_print.jpg}
    \centering{\begin{source}Author's results in Python.\end{source}}\vspace{-1em}
\end{figure}
