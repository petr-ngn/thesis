...
\label{sec:repo}
The whole machine learning implementation as the scope of this thesis is developed mainly using Python Programming Language and further with collaboration of Git and HTML.
...
\item \texttt{models} - Directory containing the sub--directories of the trained and fitted objects for features preprocessing, feature selection and model selection, including the final objects used in evaluation or deployment.
